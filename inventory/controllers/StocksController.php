		...
		********************************************************/
		...
		if($_FILES['import_path']['tmp_name'])
		{
			...
			for ($row = 6; $row <= $highestRow; ++$row) {
				$stocks = array(
					'stockID'=> $objWorksheet->getCellByColumnAndRow(2, $row)->getValue(),
					...
					'unit'=>$objWorksheet->getCellByColumnAndRow(7, $row)->getValue(),
					...
					'threshold_limit'=>$objWorksheet->getCellByColumnAndRow(9, $row)->getValue(),
					'location'=>$objWorksheet->getCellByColumnAndRow(8, $row)->getValue(),
					'batch_number'=>$objWorksheet->getCellByColumnAndRow(18, $row)->getValue(),
					'supplierID'=>$objWorksheet->getCellByColumnAndRow(11, $row)->getCalculatedValue(),
					'amount'=>$objWorksheet->getCellByColumnAndRow(19, $row)->getValue(),
	...
	***************************/
	...
	public function actionImportdata()
	{
		...
		foreach($arr as $scholar){
			...
			$stock->location=$scholar['lastname'];$scholar['location'];
